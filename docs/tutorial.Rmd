...
```{r warning=FALSE, fig.height=10, error = TRUE}
...
## Fit copy number for gWalks, a.k.a linear decomposition of graphs
...
There are many mutagenesis pathways producing various patterns of SVs in the cancer genomes. By identifying the specific motif that are in the 