...
```{r, deletions and rigma, warning = FALSE, cache = TRUE, fig.width = 8, collapse = TRUE, cache = TRUE, warning = FALSE, echo = FALSE, results = "hide", message = FALSE}
hcc1954 = del(hcc1954)
...
```{r, duplications and pyrgo, warning = FALSE, cache = TRUE, fig.width = 8, collapse = TRUE, cache = TRUE, warning = FALSE, echo = FALSE, results = "hide", message = FALSE}
...
colo668 = gG(jabba = ccle["COLO_668"])
colo668 = amp(colo668)
...
h2228 = gG(jabba = ccle[])
for (cp in setdiff(uni(gg$edgesdt$chromoplexy), c(0, NA))){                                                                                                                                                                    
    plot(gg$gt, gg$edges[which(chromoplexy==cp)]$shadow %>% streduce(5e6))                                                                                                                                                     
}
```
